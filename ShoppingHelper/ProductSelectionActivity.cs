    ...
    public class ProductSelectionActivity : Activity, INoticeDialogListener, IItemTouchHelperAdapter
    {
        ...
        protected override void OnStart()
        {
            ...
            _connection
                .QueryAsync<Product>(
                    ...
                    "order by Product.OrderId", _shoppingListId)
                .ContinueWith(r =>
                {
                    _products.Clear();
                ...
                .ContinueWith(r =>
                {
                    _shoppingList = _connection.GetWithChildrenAsync<ShoppingList>(_shoppingListId).Result;
                });
        }
        ...
        public void OnDialogPositiveClick(DialogFragment dialog)
        {
            ...
            if (product == null)
            {
                ...
                _connection
                    .InsertAsync(product)
                    .ContinueWith(t1 => _connection.UpdateWithChildrenAsync(product)
